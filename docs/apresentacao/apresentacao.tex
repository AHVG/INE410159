...
\begin{frame}{Recorte e Amostras (Abordagem Clássica)}
    \begin{table}
        ...
        \begin{tabular}{ll}
            ...
            Validação manual & 35 tiles revisados \\
            \bottomrule
        \end{tabular}
    \end{table}
\end{frame}
...
\begin{frame}{Visão Geral do Pipeline}
    \centering
    \includegraphics[height=0.80\textheight]{../../data/output/pipeline_exemplo_filtro_classico.png}
\end{frame}
...
\begin{frame}{Comparação das Duas Abordagens}
    \begin{table}
        ...
        \begin{tabular}{lll}
            ...
            Resultado & P 86,3 / R 71,6 / F1 78,3 & 1.226 mapeadas; 54,3\% global \\
            \bottomrule
        \end{tabular}
    \end{table}
    \vspace{0.3em}
...
\begin{frame}{Conclusões e Trabalhos Futuros}
    \begin{itemize}
        ...
        primeira estimativa espacial: 1.218 regiões, 86,3\% de precisão, 71,6\% de recall.
