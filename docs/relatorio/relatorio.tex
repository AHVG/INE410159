...
\begin{figure}[H]
    ...
    \caption{Visualização das imagens de inspeção do pipeline sobre
             \texttt{tile\_0634.jpg}. Da esquerda para a direita, de cima para
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth, trim={472bp 486bp 945bp 0bp}, clip]{../../data/output/passo_a_passo/tile_0634.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim={945bp 486bp 472bp 0bp}, clip]{../../data/output/passo_a_passo/tile_0634.png}
        \caption{Canal H.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim={1417bp 486bp 0bp 0bp}, clip]{../../data/output/passo_a_passo/tile_0634.png}
        \caption{Canal S.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=\textwidth, trim={0bp 0bp 1417bp 486bp}, clip]{../../data/output/passo_a_passo/tile_0634.png}
        \caption{Canal V.}
    \end{subfigure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth, trim={472bp 0bp 945bp 486bp}, clip]{../../data/output/passo_a_passo/tile_0634.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth, trim={945bp 0bp 472bp 486bp}, clip]{../../data/output/passo_a_passo/tile_0634.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.62\textwidth, trim={1417bp 0bp 0bp 486bp}, clip]{../../data/output/passo_a_passo/tile_0634.png}
...
\pendente{Esta seção depende dos resultados quantitativos do pipeline SAM 3 + YOLOv8,
que ainda não constam no material fornecido (o relatório da frente neural termina em
``Métricas de avaliação''). Preencher com: métricas de detecção no conjunto de teste
(Precisão, Recall, F1, mAP50, mAP50-95), curvas Precision-Recall e de treinamento,
importância dos hiperparâmetros (Random Forest / Mean Decrease Impurity), contagem
final de indivíduos mapeados por categoria (i/ii/iii) e figuras qualitativas de
detecção e segmentação sobre o ortomosaico.}
...
Resultado & P 84,6\% / R 52,4\% / F1 64,7\% & \pendente{a definir} \\
\bottomrule
\end{tabular}
\end{table}
...
fica limitado (52,4\%) e há fusão de copas próximas. A abordagem neural procura
...
84,6\% de precisão e 52,4\% de recall. O filtro final reduz fortemente os falsos
...
dados. A metodologia está completa e descrita em detalhe; \pendente{os resultados
quantitativos da frente neural ainda precisam ser incorporados a partir do material
final dessa etapa.}
...
\begin{enumerate}
    ...
    \item \textbf{Abordagem neural:} concluir a avaliação quantitativa, estender a
    correção semi-automatizada ao conjunto de treinamento e testar a replicabilidade
    do pipeline para outras espécies arbóreas.
